...
int main(){
    ...
    //but cannot dereferrence that. bcz කියක් කරන්න ඕනද කියලා දන්නෙ නෑනෙ(doesnt know the number of bytes required to derefference) only the address can be printed.
